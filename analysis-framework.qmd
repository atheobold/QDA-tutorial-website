...
that are responsive to your research questions" (Merriam and Tisdell, 2016).
...
these units will answer a study's research question(s). Lincoln and Guba (1985)
suggest that a unit of analysis ought to meet two criteria. First, the UOA 
should be heuristic, that is, it should reveal information pertinent to the
study and move the reader to think beyond the singular piece of information. 
...
In the [Block Model](https://dl.acm.org/doi/10.1145/1404520.1404535), each row
represents one selection for the unit of analysis and each column speaks to a
